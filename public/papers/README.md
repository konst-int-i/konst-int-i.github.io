...
Author order was checked against the arXiv abstract pages and PDF front matter. Konstantin Hemker and Andrew H. Song contributed equally to SEAL. Cristina Almagro-Pérez and Andrew H. Song contributed equally to VORTEX.

## Restored existing thumbnails

- `src/assets/SIR_paper_overview.jpg`: https://konst-int-i.github.io/assets/SIR_paper_overview.jpg
- `src/assets/hate_speech_paper_overview.jpg`: https://konst-int-i.github.io/assets/hate_speech_paper_overview.jpg

Both JPEGs were restored unchanged from the existing live website.

## Existing links

HEALNet now links to its [NeurIPS 2024 proceedings PDF](https://proceedings.neurips.cc/paper_files/paper/2024/file/765871e77d2ca65126d3d64d31aa6908-Paper-Conference.pdf). Its 2023 workshop award is retained in Grants & Awards. The former CGXplain code URL returned HTTP 404 on verification, so that action is omitted. Augment to Prevent’s author order follows the [university publication record](https://portal.fis.tum.de/en/publications/augment-to-prevent-short-text-data-augmentation-in-deep-learning-); its former generic GitHub profile link is omitted.
